...
| `coursework/evidence/release-build-20260916-1ad279671/` | Release build provenance: retained full-build completion at 6838/6838 plus a later full default-target incremental verification at 545/545, exit 0; the latter is explicitly not reported as a clean rebuild. |
